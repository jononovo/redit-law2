-- Drop the stale trigger and function before inserting
DROP TRIGGER IF EXISTS brand_index_search_vector_trigger ON brand_index;
DROP FUNCTION IF EXISTS brand_index_search_vector_update();
...
-- Verify count
SELECT COUNT(*) as brand_count FROM brand_index;
