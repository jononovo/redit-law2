        ...
        <section className="pt-32 pb-20 relative overflow-hidden">
          <div className="container mx-auto px-6 relative z-10">
            <div className="text-center max-w-3xl mx-auto mb-20">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-none bg-neutral-800 text-neutral-400 font-semibold text-sm mb-6" data-testid="badge-subtitle">
              ...
              >
                How <span className="text-neutral-500">brands.sh</span> works.
              </h1>
              ...
              {STEPS.map((step, index) => (
                ...
                >
                  <div className="flex flex-col items-center shrink-0">
                    <div className={`w-16 h-16 rounded-none ${step.color} flex items-center justify-center`}>
                      <step.icon size={28} />
                    </div>
                    {index < STEPS.length - 1 && (
                      <div className="w-px h-16 bg-neutral-800 mt-4" />
                    )}
                  </div>
                  <div className="pt-1">
                    <span className="text-xs font-mono text-neutral-600 uppercase tracking-[0.2em]">Step {step.num}</span>
                    <h3 className="text-2xl font-extrabold text-white mt-1 mb-3">{step.title}</h3>
                    <p className="text-neutral-400 font-medium leading-relaxed text-lg">{step.description}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-3xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-extrabold text-white mb-3" data-testid="heading-whats-in-a-skill">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {WHAT_SKILLS_CONTAIN.map((item, i) => (
                  <div key={i} className="p-5 rounded-none bg-neutral-800/50 border border-neutral-700/50" data-testid={`card-skill-content-${i}`}>
                    <div className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-neutral-500 mt-0.5 shrink-0" />
                      <div>
        ...
        <section className="py-20">
          <div className="container mx-auto px-6">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl font-extrabold text-white mb-4" data-testid="heading-cta">
                Start browsing the registry.
              </h2>
              <p className="text-lg text-neutral-400 font-medium mb-10 max-w-xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/skills" data-testid="link-browse-catalog">
                  <span className="inline-flex items-center gap-2 h-14 px-8 rounded-none bg-white text-neutral-900 hover:bg-neutral-200 font-bold text-base transition-colors">
                    Browse Skills
                    <ArrowRight className="w-4 h-4" />
                  </span>
                </Link>
                <Link href="/agentic-shopping-score" data-testid="link-check-score">
                  <span className="inline-flex items-center gap-2 h-14 px-8 rounded-none border border-neutral-700 hover:bg-neutral-800 font-bold text-base text-white transition-colors">
                    Check a Score
                    <ArrowRight className="w-4 h-4" />
                  </span>
                </Link>
