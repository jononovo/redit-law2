    ...
    <div className={cn(
      ...
      <div className="relative z-10 flex justify-between items-start">
        <div className="flex flex-col">
          ...
          <div
            aria-hidden
            className="mt-2 ml-2 w-10 h-8 rounded-[15%] border border-slate-500/60 overflow-hidden relative shadow-inner bg-[radial-gradient(ellipse_at_28%_22%,rgba(255,255,255,0.55),transparent_60%),radial-gradient(ellipse_at_75%_85%,rgba(71,85,105,0.35),transparent_65%),linear-gradient(155deg,#f1f5f9_0%,#e2e8f0_22%,#cbd5e1_48%,#94a3b8_72%,#b6c2d0_100%)]"
          >
