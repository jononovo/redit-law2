      ...
      <div className="relative z-10 flex justify-between items-start">
        <div className="flex flex-col">
          ...
          >
            ...
            <div className="absolute top-0 left-0 w-[46%] h-[23%] rounded-[15%] border border-slate-600/45" />
            <div className="absolute top-0 right-0 w-[46%] h-[23%] rounded-[15%] border border-slate-600/45" />
            <div className="absolute top-[26%] left-0 w-[46%] h-[23%] rounded-[15%] border border-slate-600/40" />
            <div className="absolute top-[26%] right-0 w-[46%] h-[23%] rounded-[15%] border border-slate-600/40" />
            <div className="absolute top-[51%] left-0 w-[46%] h-[23%] rounded-[15%] border border-slate-600/40" />
            <div className="absolute top-[51%] right-0 w-[46%] h-[23%] rounded-[15%] border border-slate-600/40" />
            <div className="absolute bottom-0 left-0 w-[46%] h-[23%] rounded-[15%] border border-slate-600/45" />
            <div className="absolute bottom-0 right-0 w-[46%] h-[23%] rounded-[15%] border border-slate-600/45" />
