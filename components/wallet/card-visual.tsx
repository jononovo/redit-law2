      ...
      <div className="relative z-10 flex justify-between items-start">
        <div className="flex flex-col">
          ...
          >
            ...
            <div className="absolute top-[-2%] left-[-2%] w-[48%] h-[26%] rounded-[15%] border border-slate-600/45" />
            <div className="absolute top-[-2%] right-[-2%] w-[48%] h-[26%] rounded-[15%] border border-slate-600/45" />
            <div className="absolute top-[24%] left-[-2%] w-[48%] h-[26%] rounded-[15%] border border-slate-600/40" />
            <div className="absolute top-[24%] right-[-2%] w-[48%] h-[26%] rounded-[15%] border border-slate-600/40" />
            <div className="absolute top-[50%] left-[-2%] w-[48%] h-[26%] rounded-[15%] border border-slate-600/40" />
            <div className="absolute top-[50%] right-[-2%] w-[48%] h-[26%] rounded-[15%] border border-slate-600/40" />
            <div className="absolute bottom-[-2%] left-[-2%] w-[48%] h-[26%] rounded-[15%] border border-slate-600/45" />
            <div className="absolute bottom-[-2%] right-[-2%] w-[48%] h-[26%] rounded-[15%] border border-slate-600/45" />
