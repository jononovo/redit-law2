      ...
      <div className="relative z-10 flex justify-between items-start">
        <div className="flex flex-col">
          ...
          >
            ...
            <div className="absolute top-[5%] left-[5%] w-[41%] h-[21%] rounded-[15%] border border-slate-600/45" />
            <div className="absolute top-[5%] right-[5%] w-[41%] h-[21%] rounded-[15%] border border-slate-600/45" />
            <div className="absolute top-[28%] left-[5%] w-[41%] h-[21%] rounded-[15%] border border-slate-600/40" />
            <div className="absolute top-[28%] right-[5%] w-[41%] h-[21%] rounded-[15%] border border-slate-600/40" />
            <div className="absolute top-[51%] left-[5%] w-[41%] h-[21%] rounded-[15%] border border-slate-600/40" />
            <div className="absolute top-[51%] right-[5%] w-[41%] h-[21%] rounded-[15%] border border-slate-600/40" />
            <div className="absolute top-[74%] left-[5%] w-[41%] h-[21%] rounded-[15%] border border-slate-600/45" />
            <div className="absolute top-[74%] right-[5%] w-[41%] h-[21%] rounded-[15%] border border-slate-600/45" />
