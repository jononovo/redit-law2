...
Place docs in the matching numbered subfolder inside `internal_docs/` (e.g., `01-brands-skills-system/`, `07-platform-management/`). Modules 1–3 share `01-brands-skills-system/`. New subfolder only if 2+ docs expected.
