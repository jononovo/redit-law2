              ...
              <div className="space-y-16">
                ...
                <div data-testid="section-sharing">
                  ...
                  <div className="space-y-4 text-neutral-600 leading-relaxed">
                    ...
                    <p>
                      <strong className="text-neutral-800">Anthropic:</strong> We use Anthropic&apos;s AI models for the ASX Score Scanner, which analyzes vendor websites to generate agentic shopping readiness scores. When you use the scanner, we may send publicly available vendor website content (such as product pages and checkout flows) to Anthropic for analysis. We never send your personal financial data, payment information, transaction history, or account credentials to Anthropic. Anthropic&apos;s data handling is governed by <a href="https://www.anthropic.com/privacy" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">Anthropic&apos;s Privacy Policy</a>.
                    </p>
                    <p>
