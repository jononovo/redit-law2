...
- **Per-rail breakdown** showing how much has been spent through each payment rail (USDC Wallet, Card Wallet, Self-hosted Cards)
...
- Which payment rails each bot has access to (USDC Wallet, Card Wallet, Self-hosted Cards, etc.)
