...
- **Per-rail breakdown** showing how much has been spent through each payment rail (USDC Wallet, Card Wallet, Sub-Agent Cards)
...
- Which payment rails each bot has access to (USDC Wallet, Card Wallet, Sub-Agent Cards, etc.)
