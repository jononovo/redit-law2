...
The most familiar payment method for human buyers. Powered by Stripe, this option lets buyers pay with a credit card, debit card, or bank account. The payment is converted to USDC and deposited into your USDC Wallet.
...
Regardless of which payment method a buyer uses, all funds are deposited as USDC into the USDC Wallet you selected when creating the checkout page. You can view incoming payments in the <a href="/sales" target="_blank">Sales</a> section of the dashboard, or read the [Sales Tracking](/docs/selling/sales-tracking) docs.
