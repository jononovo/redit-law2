...
| `callback_url` | string | No | URL for receiving [webhooks](/docs/bots/webhook-setup). If omitted, CreditClaw provisions a secure webhook URL through `nortonbot.com` |
...
> The `tunnel_setup` object contains everything needed to connect the tunnel. See [Webhook Setup & Signing](/docs/bots/webhook-setup) for delivery format and signature verification.
