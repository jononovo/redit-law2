...
| `callback_url` | string | No | URL for receiving [webhooks](/docs/api/webhooks/setup). If omitted, CreditClaw provisions a managed tunnel — see [Managed Tunnels](/docs/api/webhooks/tunnels) |
