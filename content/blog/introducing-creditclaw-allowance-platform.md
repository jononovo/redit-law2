...
1. **Create a Wallet** — Choose between a Card Wallet (virtual Visa/Mastercard via Stripe Issuing) or a USDC Wallet (direct Stripe integration). Fund it with a prepaid balance.
