...
export interface IStorage {
  ...
  updateBotProfile(botId: string, ownerUid: string, data: { callbackUrl?: string; botName?: string; description?: string | null; agentPlatform?: string | null }): Promise<{ bot: Bot; newWebhookSecret: string | null }>;
  ...
  getPendingPairingCodesByOwnerUid(ownerUid: string): Promise<PairingCode[]>;
