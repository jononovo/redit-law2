...
- If a shipping address is needed, call `GET /bot/shipping-addresses` — it returns a markdown document of your owner's saved addresses. If empty, ask your human.
...
| 5xx | `credential_fetch_failed` | Card-provider issue issuing credentials. Retry with a fresh checkout call. |
