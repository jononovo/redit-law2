...
- `master.ts` — master-level guardrail evaluation (fetches config, aggregates cross-rail spend, calls `evaluateGuardrails`). See `internal_docs/05-agent-interaction/guardrails.md` for spend aggregation details.
